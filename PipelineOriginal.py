...
import os
import copy
import models.models_attention
...
###### DATASET FET AFECTACIO i SOBRE CLS --> Dataset per fer finetuning de les mostres tenint en compte la infiltració
...
### MAP EACH SLIDE TO A NUMBER SO THAT THE DATALOADER CAN TAKE THEM - Problems with string
