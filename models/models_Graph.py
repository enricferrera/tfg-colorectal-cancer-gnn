...
# Ara mateix es un model molt simple de dues capes de convolucio i un global mean pool per extreure un node representatiu per graf.
...
class GATWeight_batch(torch.nn.Module):
    ...
    def forward(self, nodes, edges, weight_edges , batch_idx):
        """
            ...
            Utilitzar la llibreria tprch.geometric per crear els graphs i els batch.
...
# Per implementar i comparar amb els GATs.
